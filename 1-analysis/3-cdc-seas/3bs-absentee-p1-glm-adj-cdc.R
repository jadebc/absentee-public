...
absentee_flu_CDC_adj = read_rds(path = absentee_flu_CDC_adj_path)
...
# Separating data
yearly_data_ill = absentee_flu_CDC_adj[str_which(string = names(absentee_flu_CDC_adj), pattern = "ill")]
yearly_data_all = absentee_flu_CDC_adj[str_which(string = names(absentee_flu_CDC_adj), pattern = "all")]
...
write_rds(x = ill.adj.fit,
          path = paste0(res_dir, "3bs_abs_glm_p1_adj_ill_cdc.RDS"))

write_rds(x = all.adj.fit,
          path = paste0(res_dir, "3bs_abs_glm_p1_adj_all_cdc.RDS"))