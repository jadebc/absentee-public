...
# Adjusted GLM for parameter 2, stratified by grade
##############################################
...
write_rds(x = ill.fit,
          path = paste0(res_dir, "4c_abs_glm_p2_adj_did_ill.RDS"))

write_rds(x = all.fit,
          path = paste0(res_dir, "4c_abs_glm_p2_adj_did_all.RDS"))
