...
# Separating data
yearly_data_ill = absentee_flu_adj[str_which(string = names(absentee_flu_adj), pattern = "ill")]
yearly_data_all = absentee_flu_adj[str_which(string = names(absentee_flu_adj), pattern = "all")]
...
write_rds(x = ill.fit,
          path = paste0(res_dir, "3b_abs_glm_p1_adj_ill.RDS"))

write_rds(x = all.fit,
          path = paste0(res_dir, "3b_abs_glm_p1_adj_all.RDS"))
