...
absentee_peakwk_adj_did = read_rds(path = absentee_peakwk_adj_did_path)
...
# Separating data
yearly_data_ill = absentee_peakwk_adj_did[str_which(string = names(absentee_peakwk_adj_did), pattern = "ill")]
yearly_data_all = absentee_peakwk_adj_did[str_which(string = names(absentee_peakwk_adj_did), pattern = "all")]
...
write_rds(x = ill.fit,
          path = paste0(res_dir, "4bp_abs_glm_p2_adj_did_ill_peakwk.RDS"))

write_rds(x = all.fit,
          path = paste0(res_dir, "4bp_abs_glm_p2_adj_did_all_peakwk.RDS"))
