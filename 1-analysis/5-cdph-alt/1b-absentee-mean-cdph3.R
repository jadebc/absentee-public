...
absentee_flu_cdph3 = read_rds(path = absentee_flu_cdph3_path)
...
absentee_flu_cdph3$pre = ifelse(
  test = absentee_flu_cdph3$schoolyr != "2014-15" &
    absentee_flu_cdph3$schoolyr != "2015-16" &
    absentee_flu_cdph3$schoolyr != "2016-17" &
    absentee_flu_cdph3$schoolyr != "2017-18",
  yes = 1,
  no = 0
)
absentee_flu_cdph3 = absentee_flu_cdph3[, c("dist",
                                        "matchid",
                                        "absent_ill",
                                        "absent_all",
                                        "schoolyr",
...
absentee_flu_cdph3 = absentee_flu_cdph3[complete.cases(absentee_flu_cdph3), ]

# create variable for pre + schoolyr
absentee_flu_cdph3 = absentee_flu_cdph3 %>%
...
write_rds(
  ...
  path = paste0(res_dir, "tables/", "1-unadj-table-raw-cdph3.RDS")
)
