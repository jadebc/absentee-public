...
# CDPH flu season definition (lower bound) 
##############################################
...
absentee_flu_cdph2 = read_rds(path = absentee_flu_cdph2_path)
...
absentee_flu_cdph2$pre = ifelse(
  test = absentee_flu_cdph2$schoolyr != "2014-15" &
    absentee_flu_cdph2$schoolyr != "2015-16" &
    absentee_flu_cdph2$schoolyr != "2016-17" &
    absentee_flu_cdph2$schoolyr != "2017-18",
  yes = 1,
  no = 0
)
absentee_flu_cdph2 = absentee_flu_cdph2[, c("dist",
                                        "matchid",
                                        "absent_ill",
                                        "absent_all",
                                        "schoolyr",
...
absentee_flu_cdph2 = absentee_flu_cdph2[complete.cases(absentee_flu_cdph2), ]

# create variable for pre + schoolyr
absentee_flu_cdph2 = absentee_flu_cdph2 %>%
...
write_rds(
  ...
  path = paste0(res_dir, "tables/", "1-unadj-table-raw-cdph2.RDS")
)
