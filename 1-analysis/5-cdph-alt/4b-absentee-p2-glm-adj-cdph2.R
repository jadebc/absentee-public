...
absentee_flu_cdph2_adj_did = read_rds(path = absentee_flu_cdph2_adj_did_path)
...
# Separating data
yearly_data_ill = absentee_flu_cdph2_adj_did[str_which(string = names(absentee_flu_cdph2_adj_did), pattern = "ill")]
yearly_data_all = absentee_flu_cdph2_adj_did[str_which(string = names(absentee_flu_cdph2_adj_did), pattern = "all")]
...
write_rds(x = ill.fit,
          path = paste0(res_dir, "4b_abs_glm_p2_adj_did_ill_cdph2.RDS"))

write_rds(x = all.fit,
          path = paste0(res_dir, "4b_abs_glm_p2_adj_did_all_cdph2.RDS"))
